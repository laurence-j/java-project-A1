...
abstract class MovingShape implements Comparable<MovingShape> {
	...
	/*
	 *  ===============================================================================
	 *  TestingPath : A Testing path.
	 *  ===============================================================================
	 */
	public class TestingPath extends MovingPath {

		public TestingPath() {
			deltaX = 1;		//set deltaX to 1
			deltaY = 2;		//set deltaY to 2
		}

		@Override
		public void move() {
			x = (x + deltaX) % (marginWidth - 1);	//increment x by deltaX until it is one unit less than marginWidth
			y = (y + deltaY) % (marginHeight);	//increment y by deltaY until it is equal to marginHeight
		}
	}

	public int compareTo(MovingShape s) {
		int result = (int) (this.getArea() - s.getArea());
		return result;
	}
}